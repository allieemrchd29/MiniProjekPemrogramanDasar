...
int main(){
    ...
    do{     //jadi bagian loop akan dijalankan lebih dulu, lalu baru dicek kondisi di akhir apakah user mau mengulang lagi or not
        ...
        if(pilihan == 1){                       //bagian conditionalnya, yang menunjukkan jika yg dipilih yaitu pilihan [1] alias Fahrenheit,
            ...
            konversiSemua(angkaCelcius);    // maka perhitungan akan menghasilkan semua hasil konversi ketiga suhunya
        } else {
            printf("II----------------------------------------II\n");
...
//interface/tampilan look, ada sederhana pake frame manual^^
//kondisional, ada
//array,  
//looping, ada
//function, ada 
//sama kasi hal yg menarik